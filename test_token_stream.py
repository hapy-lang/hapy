...
class TestTokenStream(unittest.TestCase):
	...
	def test_skip_comment(self):
		...
		self.assertEqual(expected, actual, "the stream is a comment, whitespace & string")
	...
	def test_read_operation_good(self):
		...
		self.assertEqual([expected1, expected2], [actual1, actual2], "the stream is a operation char")
